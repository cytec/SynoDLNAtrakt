...
<body>  
  ...
  <div id="update">
      <p class="alert alert-info">there is an newer version available you are <a href="http://github.com/cytec/SynoDLNAtrakt/compare/{{config.current_version}}...{{config.latest_version}}" target="_blank"><b>{{config.commits_behind}} commits behind</b></a> <a href="/settings/force/update">update now</a></p>
  </div>
  %end if
