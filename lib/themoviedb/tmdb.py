...
class MovieDb:
    ...
    def mediaGetInfo(self, hash, size, lang):
...
def search(name, lang="en"):
    ...
    """
    mdb = MovieDb()
    return mdb.search(name, lang)


def getMovieInfo(id, lang="en"):
    """Convenience wrapper for MovieDb.search - so you can do..
    ...
    """
    mdb = MovieDb()
    return mdb.getMovieInfo(id, lang)


def mediaGetInfo(hash, size, lang="de"):
    ...
    """
    mdb = MovieDb()
    return mdb.mediaGetInfo(hash, size, lang)
