...
formats = {
    ...
    # lighttpd log format
    'lighttpd':r'%h %d - %t \"%r\" %s %b \"%{Referer}i\" \"%{User-Agent}i\"',
    }
...
if __name__ == '__main__':
    ...
    class TestApacheLogParser(unittest.TestCase):
        ...
        def setUp(self):
            ...
            self.line4  = r'111.235.72.230 terzo.org - [08/Aug/2011:05:53:11 +'\
                          r'0000] "GET /route1.jpg HTTP/1.1" 200 202073 "http://'\
                          r'terzo.org/" "Mozilla/5.0 (Windows NT 5.1; rv:6.0) '\
                          r'Gecko/20100101 Firefox/6.0"'
        ...
        def testline4(self):
            ...
            self.assertEqual(data['%t'], '[08/Aug/2011:05:53:11 +0000]', 
                'Line 4 %t')
            self.assertEqual(data['%b'], '202073', msg = 'Line 4 %t')
            self.assertEqual( data['%{Referer}i'], 'http://terzo.org/', 
                msg = 'Line 4 %{Referer}i')
            self.assertEqual( data['%{User-Agent}i'], 
                'Mozilla/5.0 (Windows NT 5.1; rv:6.0) Gecko/20100101 '\
                'Firefox/6.0',
